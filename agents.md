...
Suite completa: **67 tests pasando** (`npx vitest run`; 48 del protocolo/servidor + 19 E2E del servidor).
*(Nota: la operativa actual usa el conteo dinámico real; la última verificación es 67/67 tras TASK-031.)*
